---
title: "Accessibilité"
description: "Déclaration d'accessibilité du site du master Humanités numériques de l'École nationale des chartes – PSL, établie conformément au RGAA 4.1.2."
draft: false
---

## Déclaration d’accessibilité

L’**École nationale des chartes – PSL** s’engage à rendre ses services de
communication au public en ligne accessibles conformément à l’article 47 de la
...
**Digital humanities @ Chartes — master Humanités numériques**
(`https://chartes.github.io/dh-website/`).
...
- Les **notices bibliographiques** affichées dans la rubrique
  *Publications* et les **mémoires** présentés sur la page du master sont importés
  au moment de la génération du site depuis les entrepôts ouverts
  **HAL** et **DUMAS**. Il s’agit de contenus de tiers, ni financés, ni développés
  par l’École, et qui ne sont pas sous son contrôle
  (décret n° 2019-768 du 24 juillet 2019, article 3).
- Les **dépôts de code hébergés sur GitHub** et les **modèles publiés sur
  HuggingFace**, vers lesquels le site renvoie par des liens externes, relèvent de
  services tiers et sont hors du champ de la présente déclaration.
...
HTML5, CSS3, JavaScript, Hugo (générateur de site statique), Bootstrap 4.

### Environnement de test

Les vérifications ont été menées avec Chromium (moteur Blink) piloté par
Puppeteer, et avec un moteur de résolution de cascade CSS développé pour cet
audit afin de mesurer les contrastes réels, fonds composites compris.

### Outils pour évaluer l’accessibilité

- axe-core 4.11
- pa11y (moteurs `axe` et `HTML_CodeSniffer`, standard WCAG2AA)
- html-validate
- calcul des contrastes WCAG par résolution de la cascade CSS et échantillonnage
  des images de fond
- inspection manuelle du code source et du HTML généré, critère par critère

### Pages du site ayant fait l’objet de la vérification de conformité

- [Accueil](/)
- [Master HN](/master/)
- [Équipe enseignante](/equipe/) et une fiche d’enseignant
- [Écosystème de recherche](/projets/)
- [Développements](/developpements/)
...
- [Accessibilité](/accessibilite/) — la présente page
