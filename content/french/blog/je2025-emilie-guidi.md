...
Les courbes de profil de diversité pour analyser la représentation des textes (comme la courbe *e-profile*, agrégeant les estimateurs de Shannon-Weaver ou Simpson), indiquent un processus non équilibré où certains textes sont surreprésentés et d'autres très rares. La courbe d'extrapolation suggérait que 7 465 manuscrits étaient encore manquants pour une couverture complète.
